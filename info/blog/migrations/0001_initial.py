    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.AutoField(serialize=False, verbose_name='\u7f16\u53f7', primary_key=True)),
                ...
                ('vip', models.IntegerField(default=0, verbose_name='vip\u7528\u6237')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_publish', models.DateTimeField(auto_now_add=True, verbose_name='\u53d1\u5e03\u65f6\u95f4')),
                ('score', models.IntegerField(null=True, verbose_name='\u7ad9\u957f\u8bc4\u5206', blank=True)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='article',
            name='tag',
            field=models.ManyToManyField(to='blog.Tag', verbose_name='\u6807\u7b7e', through='blog.ArticleTag'),
        ),
        migrations.AddField(
            model_name='article',
            name='user',
